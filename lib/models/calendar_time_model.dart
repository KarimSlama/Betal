class CalendarTimeModel {
  int? code;
  String? status;
  List<Data>? data;

  CalendarTimeModel({this.code, this.status, this.data});

  CalendarTimeModel.fromJson(Map<String, dynamic> json) {
    code = json['code'];
    status = json['status'];
    if (json['data'] != null) {
      data = <Data>[];
...
class MonthNumber {
  ...
  MonthNumber({this.number, this.en});

  MonthNumber.fromJson(Map<String, dynamic> json) {
    number = json['number'];
    en = json['en'];
  }
